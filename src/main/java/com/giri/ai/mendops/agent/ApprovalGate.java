...
public class ApprovalGate {
    ...
    /**
     * Runs the real action for a pending approval. Throws IllegalStateException
     * if it's already been resolved (approved or rejected) - approvals are
     * one-shot, not re-runnable.
     */
